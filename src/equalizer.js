...
class Equalizer {
    ...
    setupFilters() {
        ...
        // Desconectar la ruta directa para que el sonido solo pase por los filtros
        try {
            audioSource.disconnect();
        } catch (e) {
            console.log("No se pudo desconectar la ruta original", e);
        }
        ...
        // Conectar de nuevo al analizador
